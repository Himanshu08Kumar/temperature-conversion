...
var _default = (unit, value) => `<div class="conversion">
...
const renderUI = function (t) {
  outputDiv.innerHTML = (0, _Row.default)('Kelvin', kelvin(Number(t))) + (0, _Row.default)('Fahrenheit', fahrenheit(Number(t)));
};
inputEl.addEventListener('keyup', evt => {
  evt.preventDefault();
  renderUI(evt.target.value);
});
renderUI(0);
},{"./Row":"js/Row.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
